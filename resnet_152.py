...
from load_insect import load_data
...
def resnet152_model(img_rows, img_cols, color_type=1, num_classes=None):
    ...
    # rmsprop = RMSprop(lr=1e-06, rho=0.9, epsilon=1e-08, decay=0.0)
...
if __name__ == '__main__':
    ...
    checkpoint = ModelCheckpoint('model/weights.{epoch:02d}-{val_acc:.8f}.hdf5', monitor='val_acc', verbose=1, save_best_only=False, save_weights_only=False, mode='max')
    # Start Fine-tuning
